...
window.FT_DATA = {
  // >>> TOAST-SYNC:START — menuCategories + menuItems below are regenerated by
  // .github/scripts/toast-sync.mjs from Toast Menus API V2. Do not hand-edit this
  // region; edits are overwritten on the next sync. Everything outside the markers
  // (press, buzz, specials, dishes, etc.) stays hand-maintained.
  menuCategories: [
